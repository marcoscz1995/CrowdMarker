...
if __name__ == "__main__":
    ...
    max_score = 8
    user_input = [[r"partials in wrong order in use of greens thrm. need to write $\frac{F_2}{dx}-\frac{F_1}{dy}$, but you have (most likely) $F_1$ and $F_2$ swapped.", -2, "KEY_W"],
                  [r"order of integration backwards. swap $dx$ w/ $dy$", -1, "KEY_A"],
                  [r"y integral bounds are wrong.", -1.5, "KEY_R"],
                  [r"x integral bounds are wrong.", -1.5, "KEY_Y"],
                  [r"wrong final answer", -1, "KEY_V"]]
