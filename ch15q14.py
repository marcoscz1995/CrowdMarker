...
if __name__ == "__main__":
    ...
    max_score = 7
    user_input = [[r"explain where where these values came from", -3, "KEY_W"],
                  [r"your $\rho$ bounds is in the wrong place, needs to match up with order of $d\rho$", -1, "KEY_A"],
                  [r"this integral bounds is wrong.", -1, "KEY_R"],
                  [r"intrgrand is wrong", -3, "KEY_V"]]
