...
if __name__ == "__main__":
    ...
    max_score = 8
    user_input = [[r"show what integration technique used here", -1, "KEY_R"],
                  [r"your integrand bounds for $r$ are for $\theta$. need to swap them.", -1, "KEY_A"],
                  [r"$\theta$ bounds wrong.", -1.5, "KEY_W"]]
